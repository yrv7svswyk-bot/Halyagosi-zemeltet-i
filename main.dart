  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
          ...
          items: const [
            BottomNavigationBarItem(icon: Icon(Icons.water), label: ' to'),
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: const Color(0xFF2ED47A).withOpacity(0.3)),
                      ),
                        ...
                        children: [
                          Row(children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  color:
                                      const Color(0xFF2ED47A).withOpacity(0.2),
                          ...
                          FutureBuilder(
                            ...
                            builder: (ctx, snap) {
                              ...
                              double sum = 0;
                              for (var r in data)
                                sum += (r['suly_kg'] as num? ?? 0).toDouble();
                              return Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('${data.length} telepites',
                                      style: const TextStyle(
                                          color: Color(0xFFB9F5C8),
                                          fontSize: 11,
                                          fontWeight: FontWeight.bold)),
                                  Text('${sum.toStringAsFixed(0)} kg osszesen',
                                      style: const TextStyle(
                                          color: Color(0xFF7FB09A),
                                          fontSize: 10)),
                                ],
                ...
                Expanded(
                  child: InkWell(
                    onTap: () => Navigator.push(context,
                        MaterialPageRoute(builder: (_) => const FogasokPage())),
                    child: Container(
                      height: 110,
                      decoration: BoxDecoration(
                        ...
                        children: [
                          ...
                          FutureBuilder(
                            ...
                            builder: (ctx, snap) {
                              ...
                              double yearSum = 0;
                              for (var r in data)
                                if ((r['ev'] ?? 0) == currentYear)
                                  yearSum +=
                                      (r['suly_kg'] as num? ?? 0).toDouble();
                              return Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('${data.length} bejegyzes',
                                      style: const TextStyle(
                                          color: Color(0xFFFFE0A0),
                                          fontSize: 11,
                                          fontWeight: FontWeight.bold)),
                                  Text(
                                      '$currentYear: ${yearSum.toStringAsFixed(0)} kg',
                                      style: const TextStyle(
                                          color: Color(0xFF7FB09A),
                                          fontSize: 10)),
                                  Text('Ossz: ${sum.toStringAsFixed(0)} kg',
                                      style: const TextStyle(
                                          color: Color(0xFF7FB09A),
                                          fontSize: 9)),
                                ],
...
class _TelepitesPageState extends State<TelepitesPage> {
    ...
    try {
      ...
      if (mounted)
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text('$kivalasztottFaj $suly kg mentve'),
        ...
        builder: (ctx, setD) => AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              DropdownButtonFormField<String>(
                ...
                onChanged: (v) {
                  if (v != null) {
                    setState(() => kivalasztottFaj = v);
                    setD(() => kivalasztottFaj = v);
                  }
                },
              ),
              SizedBox(height: 12),
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    Icon(Icons.calendar_today,
                        color: Color(0xFF2ED47A), size: 16),
                    SizedBox(width: 8),
                    Text(
                        '${kivalasztottDatum.year}.${kivalasztottDatum.month}.${kivalasztottDatum.day}',
                        style: TextStyle(color: Colors.white, fontSize: 13)),
                  ]),
                ),
              ),
          ...
          actions: [
            ...
            FilledButton(
                onPressed: hozzaad,
                style:
                    FilledButton.styleFrom(backgroundColor: Color(0xFF2ED47A)),
                child: Text('Mentes',
                    style: TextStyle(
  ...
  Future<void> torles(id) async {
    bool? ok = await showDialog<bool>(
        ...
        builder: (c) => AlertDialog(
                backgroundColor: Color(0xFF14352E),
                title: Text('Torlod?', style: TextStyle(color: Colors.white)),
                actions: [
                  TextButton(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color(0xFF0A332A),
        title: Text('Telepitesek - ${ossz.toStringAsFixed(0)} kg',
            style: TextStyle(
                color: Colors.white,
                fontSize: 14,
                fontWeight: FontWeight.bold)),
        ...
        actions: [
          IconButton(
              icon: Icon(Icons.add, color: Color(0xFF2ED47A)),
                  ...
                  children: [
                    ...
                    Expanded(
                        child: CustomPaint(
                            ...
                            painter: BarChartPainter(fajOssz,
                                barColor: Color(0xFF2ED47A)))),
                  ]),
            ),
          ]),
        Expanded(
                    ...
                    return ListTile(
                      title: Text('${r['faj']}',
                          style: TextStyle(
                              ...
                              fontSize: 13,
                              fontWeight: FontWeight.bold)),
                      subtitle: Text('${r['datum']} - ${r['suly_kg']} kg',
                          style: TextStyle(
                              color: Color(0xFF7FB09A), fontSize: 11)),
                      trailing: IconButton(
      ...
      floatingActionButton: FloatingActionButton(
          onPressed: showAddDialog,
          backgroundColor: Color(0xFF2ED47A),
          child: Icon(Icons.add, color: Color(0xFF081F1A))),
    );
  }
}
...
class _FogasokPageState extends State<FogasokPage> {
  ...
  Future<void> hozzaad() async {
    ...
    try {
      await Supabase.instance.client
          .from('fogasok')
          .insert({'faj': kivalasztottFaj, 'suly_kg': suly, 'ev': ev});
      if (mounted) Navigator.pop(context);
      sulyCtrl.clear();
      await betoltes();
      if (mounted)
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text('$kivalasztottFaj $suly kg $ev mentve'),
        ...
        builder: (ctx, setD) => AlertDialog(
          ...
          content: Column(mainAxisSize: MainAxisSize.min, children: [
            DropdownButtonFormField<String>(
              ...
              items: fajok
                  .map((f) => DropdownMenuItem(
                      value: f, child: Text(f, style: TextStyle(fontSize: 12))))
                  .toList(),
              onChanged: (v) {
                if (v != null) {
                  setState(() => kivalasztottFaj = v);
          ...
          actions: [
            ...
            FilledButton(
                onPressed: hozzaad,
                style:
                    FilledButton.styleFrom(backgroundColor: Color(0xFFFFB84D)),
                child: Text('Mentes',
                    style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color(0xFF1A150A),
        title: Text('Fogasok - ${ossz.toStringAsFixed(0)} kg ossz',
            style: TextStyle(
                color: Colors.white,
                fontSize: 14,
                fontWeight: FontWeight.bold)),
        ...
        actions: [
          IconButton(
              icon: Icon(Icons.add, color: Color(0xFFFFB84D)),
              onPressed: showAddDialog)
        ],
      ),
      body: Column(children: [
          ...
          Column(children: [
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border:
                      Border.all(color: Color(0xFFFFB84D).withOpacity(0.2))),
              child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Osszesites ev szerint',
                        style: TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold,
                            fontSize: 12)),
                                ...
                                children: [
                                  Text('$ev',
                                      style: TextStyle(
                                          ...
                                          fontSize: 12,
                                          fontWeight: FontWeight.bold)),
                                  Text('${evOssz[ev]!.toStringAsFixed(0)} kg',
                                      style: TextStyle(
                    ...
                    Expanded(
                        child: CustomPaint(
                            ...
                            painter: BarChartPainter(
                                evOssz.map((k, v) => MapEntry(k.toString(), v)),
                                barColor: Color(0xFFFFB84D)))),
                  ]),
            ),
            SizedBox(height: 8),
            Container(
          ...
          child: adatok.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    var r = adatok[i];
                    return ListTile(
                      title: Text('${r['faj']} - ${r['ev']}',
                          style: TextStyle(
                              color: Colors.white,
                              fontSize: 13,
                              fontWeight: FontWeight.bold)),
                      subtitle: Text('${r['suly_kg']} kg',
                          style: TextStyle(
                              color: Color(0xFF7FB09A), fontSize: 11)),
                      trailing: IconButton(
                          icon: Icon(Icons.delete,
      ...
      floatingActionButton: FloatingActionButton(
          onPressed: showAddDialog,
          backgroundColor: Color(0xFFFFB84D),
          child: Icon(Icons.add, color: Color(0xFF2E2414))),
    );
  }
}
...
class _ChippeltHalakPageState extends State<ChippeltHalakPage> {
  ...
  Future<String?> uploadImage(
      Uint8List bytes, String chipId, String name) async {
    try {
      final fileName =
    ...
    try {
      ...
      for (int i = 0; i < pickedImagesBytes.length; i++) {
        String? url = await uploadImage(
            pickedImagesBytes[i], chipId, pickedImagesNames[i]);
        if (url != null) {
          try {
      ...
      loadAll();
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text('$chipId mentve'), backgroundColor: Color(0xFF2ED47A)));
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text('Mentes hiba: $e'), backgroundColor: Colors.red));
    }
  }
                        ...
                        child: Column(children: [
                          ...
                          SizedBox(
                              ...
                              child: OutlinedButton.icon(
                                  ...
                                  label: Text(
                                      '${pickedImagesBytes.length} kep kivalasztva'),
...
class _HalReszletekPageState extends State<HalReszletekPage> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Map<String, dynamic>> sulyHistory = [
      ...
      {
        "date": "2025.09",
        "kg": double.tryParse(suly.replaceAll(',', '.')) ?? 18.2
      }
    ];
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
          ...
          child:
                        ...
                        return ClipRRect(
                            ...
                            child: Stack(children: [
                              Image.network(kepek[i]['image_url'],
                                ...
                                print(
                                    'KEP BETOLTESI HIBA: ${kepek[i]['image_url']} - $b');
                                return Container(
                                  width: 180,
                                  height: 140,
                                  color: Color(0xFF1B4D3E),
                ...
                child: Row(children: [
                  ...
                  IconButton(
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text('Chip masolva: $chip')));
                      },
            ...
            if (meresek.isEmpty) ...[
              _fogasCard(
                  '2025.09.20', '$suly kg - Fogo: Csaba Busai', true, null)
            ] else ...[
  ...
  void paint(Canvas canvas, Size size) {
    ...
    data.forEach((key, value) {
      ...
      RRect r = RRect.fromRectAndRadius(
          Rect.fromLTWH(x, y, barWidth, barHeight), Radius.circular(6));
      ...
      final tp2 = TextPainter(
          text: TextSpan(
              text: label,
              style: TextStyle(color: Color(0xFF7FB09A), fontSize: 7)),
          textDirection: TextDirection.ltr);
      tp2.layout(maxWidth: barWidth + 10);
      tp2.paint(
          canvas, Offset(x + barWidth / 2 - tp2.width / 2, size.height - 14));
      i++;
    });
  }
...
class LineChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    double maxY =
        points.map((e) => e['y'] as double).reduce((a, b) => a > b ? a : b);
    double minY =
        points.map((e) => e['y'] as double).reduce((a, b) => a < b ? a : b);
    if (maxY == minY) maxY += 1;
    ...
    final fillPaint = Paint()
      ..color = Color(0xFF2ED47A).withOpacity(0.15)
      ..style = PaintingStyle.fill;
    Path path = Path();
    Path fillPath = Path();
    for (int i = 0; i < points.length; i++) {
      double x =
          (i / (points.length - 1 == 0 ? 1 : points.length - 1)) * size.width;
      double y = size.height -
          20 -
          ((points[i]['y'] - minY) / (maxY - minY)) * (size.height - 40);
      if (i == 0) {
        path.moveTo(x, y);
...
class _NapijegyPageState extends State<NapijegyPage> {
  ...
  Future<void> mentes() async {
    ...
    try {
      ...
      await Supabase.instance.client
          .from("napijegyek")
          .insert({"tipus": tipusMent, "db": db, "datum": ma});
      ...
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              content: Text('Jegy mentes hiba: $e2'),
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text('$db db $tipusMent mentve'),
          backgroundColor: Color(0xFF2ED47A)));
    }
    await betoltes();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
          ...
          label: const Text("Uj jegy",
              style: TextStyle(color: Color(0xFF081F1A), fontSize: 12))),
      body: SingleChildScrollView(
          ...
          child: Column(children: [
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Text(osszDb.toString() + " db",
                          style: const TextStyle(
                              color: Color(0xFF6EE7A0), fontSize: 11))
                    ])),
            ...
            if (nezet == "Napi") ...[
              ...
              Align(
                  ...
                  child: Text("Napi lista (" + szurt.length.toString() + ")",
                      style: const TextStyle(
                          color: Colors.white,
                          fontWeight: FontWeight.bold,
                          fontSize: 12))),
